            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link {{ str_contains(request()->path(), 'users') ? 'active' : '' }}" href="{{ route('users.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ str_contains(request()->path(), 'projects') ? 'active' : '' }}" href="{{ route('projects.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ str_contains(request()->path(), 'tasks') ? 'active' : '' }}" href="{{ route('tasks.index') }}">
